                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('Warehouse.update',$warehouse->id) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="my-input" class="form-control" type="text" name="location" value="{{ $warehouse->location }}">
                        </div>

                        <div class="form-group">
                            <label for="my-input" class="mb-2">Phone</label>
                            <input id="my-input" class="form-control" type="number" name="phone_number" value="{{ $warehouse->phone_number }}">
                        </div>

                        <div class="form-group">
                            <label for="my-input" class="mb-2">Email</label>
                            <input id="my-input" class="form-control" type="email" name="email" value="{{ $warehouse->email }}">
                        </div>

                        <div class="form-group">
                            <label for="m-name" class="mb-2">Manager Name</label>
                            <input id="m-name" class="form-control" type="text" name="manager_name" value="{{ $warehouse->manager_name }}">
                        </div>
